...
import 'package:myapp/page-1/YourHive.dart';
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(1 * fem, 34 * fem, 0 * fem, 0 * fem),
                width: 414 * fem,
                height: 499 * fem,
                child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            padding: EdgeInsets.fromLTRB(
                                7.25 * fem, 11 * fem, 7.17 * fem, 8.77 * fem),
                            width: 50 * fem,
