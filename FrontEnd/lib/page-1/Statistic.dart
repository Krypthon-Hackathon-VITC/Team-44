        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: Container(
                padding: EdgeInsets.fromLTRB(
                    32 * fem, 83.33 * fem, 24 * fem, 16 * fem),
                width: 414 * fem,
                height: 271 * fem,
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          1.8 * fem, 0 * fem, 3.5 * fem, 42.33 * fem),
                      width: double.infinity,
                    ...
                    Container(
                      // frame17dbN (9:1970)
                      margin: EdgeInsets.fromLTRB(
                          238 * fem, 0 * fem, 0 * fem, 0 * fem),
                      padding: EdgeInsets.fromLTRB(
                          16 * fem, 11.5 * fem, 21 * fem, 11.5 * fem),
                      width: double.infinity,
                      decoration: BoxDecoration(
            ...
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(1 * fem, 60 * fem, 0 * fem, 0 * fem),
                width: 414 * fem,
                height: 436 * fem,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
